...
# 6. Verify on GitHub (check under your feature branch)

# 7-8. Create and merge Pull Request on GitHub
# Go to repository on GitHub → "Pull requests" tab → "New pull request"
...
# 7. Reverse roles (your colleague does the same on your repo)
...
# Or manually: Pull requests → New → Select your branch
...
# After merging, delete on GitHub (button appears)
# Locally:
git checkout main
...
# 6. Reverse roles (repeat with your colleague as contributor)
...
# If you need to update feature branch with latest main
